...
os.system("clear")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}Jangan Lupa kunjungi rabihdigital.com")
time.sleep(3)
os.system("xdg-open https://rabihdigital.com")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}thank you !!!!")
time.sleep(3)
os.system("clear")
autoketik(f"""
...
{abu}-----------------------------------------
{putih}[{biru}•{putih}] {biru}Author {putih}   : White Hodie
{putih}[{biru}•{putih}] {abu}GitHub {putih}   : White Hodie
{putih}[{biru}•{putih}] {merah}You{putih}Tube {putih}  : White Hodie
{putih}[{biru}•{putih}] {ungu}Instagram {putih}: @azizhartadi
